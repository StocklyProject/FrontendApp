...
class CandleChartDay extends StatefulWidget {
  final String symbol;
  final Map<String, dynamic>? newData; // 상위 위젯에서 받은 실시간 주식 데이터

  const CandleChartDay({
    Key? key,
  ...
  @override
  _CandleChartDayState createState() => _CandleChartDayState();
}

class _CandleChartDayState extends State<CandleChartDay> {
  ...
  @override
  void didUpdateWidget(covariant CandleChartDay oldWidget) {
